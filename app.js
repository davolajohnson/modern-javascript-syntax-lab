...
console.log(firstIngredient);      // Prints: Pineapple
console.log(secondIngredient);    // Prints: Olives
...
console.log(make);   // Prints: Audi
console.log(model);  // Prints: Q5
